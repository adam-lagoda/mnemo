package com.lagoda.mnemo.notification
...
object NotificationHelper {
    ...
    fun createChannel(context: Context) {
        val channel = NotificationChannel(
            CHANNEL_ID,
            context.getString(com.lagoda.mnemo.R.string.notification_channel_name),
            NotificationManager.IMPORTANCE_DEFAULT
        ).apply {
            description = context.getString(com.lagoda.mnemo.R.string.notification_channel_desc)
    ...
    private fun mainActivityIntent(context: Context): PendingIntent {
        val intent = Intent(context, Class.forName("com.lagoda.mnemo.MainActivity")).apply {
    ...
    fun sendDigestNotification(
        ...
        val tapIntent = Intent(context, Class.forName("com.lagoda.mnemo.MainActivity")).apply {
            action = "com.lagoda.mnemo.ACTION_OPEN_GALLERY"
            flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
        }
